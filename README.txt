...
-PyQt5
-Python3
-hostapd (sudo apt-get install hotsapd)
-dnsmasq (pre-installed on most linux distributions)
...
# Running Faunus from the source code

For LINUX:
1- Install Python3 _ Pre-installed on most Linux distributions.
2- Install Qt5 _ https://www.qt.io/download-open-source/
3- Install hostapd _ sudo apt-get install hotsapd
...
For Linux & Windows :
1- Install Python3 _ https://www.python.org/downloads/
2- Install QT5 with all extra features _ https://www.qt.io/download-open-source/
...
# Easy installation will be deployed with the first official version
